...
@NamedQueries({ @NamedQuery(name = "Empregado.findAll", query = "SELECT e FROM Empregado e"),
		...
		@NamedQuery(name = "Empregado.findByEmpregadoPossuiBio", query = "SELECT e FROM Empregado e WHERE e.empregadoPossuiBio = :empregadoPossuiBio"),
...
public class Empregado implements Serializable {
	...
	@Column(name = "empregado_possui_bio")
